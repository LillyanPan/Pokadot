    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-10 col-md-10">
                ...
                <div class="col-md-10">
                    <p class="ptSans">
                        We are two ladies with a passion for art and a kiln. Leigh is a special educator who loves to connect on a personal level through art with both kids and adults. Cathy is an elementary art teacher who strives to bring learning out of the classroom for all ages of artists. Together, we are Pokadot!
                    </p>
                </div>
                <div class="col-md-1"></div>
            </div>
